...
|-|-|  
|Name|Definition|  
|[IFtpProviderConstruct::Construct Method](../../../reference/ftp/native-code/iftpproviderconstruct-construct-method.md)|Retrieves an array of key/value pairs from an FTP provider's configuration settings in the IIS ApplicationHost.config file.|  
