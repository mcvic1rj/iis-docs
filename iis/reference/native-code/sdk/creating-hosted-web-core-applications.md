...
## Remarks  
 ...
 For most situations where customized functionality is required, developers should consider creating HTTP modules and hosting their applications inside IIS. For more information about how to create an HTTP module, see [Creating Native-Code HTTP Modules](../../../reference/native-code/sdk/creating-native-code-http-modules.md).  
  
## See Also  
 [Native-Code Development Overview](../../../reference/native-code/sdk/native-code-development-overview.md)   
 [Hosted Web Core API Reference](../../../web-dev-reference/native-code-api-ref/hosted-web-core-api-reference.md)