...
This walkthrough demonstrates how to use C++ to create a sample request-level HTTP module that implements the new request-processing architecture in [!INCLUDE[iisver](../../../reference/admin/includes/iisver-md.md)]. This new architecture extends the capabilities of native-code programming when you are writing IIS applications over earlier versions of [!INCLUDE[vstecasp](../../../reference/includes/vstecasp-md.md)] HTTP modules and ISAPI filters or extensions. For more information about designing HTTP modules using the new request-processing architecture, see [Designing Native-Code HTTP Modules](../../../reference/native-code/sdk/designing-native-code-http-modules.md).  
...
-   [!INCLUDE[winsdklong](../../../reference/native-code/sdk/includes/winsdklong-md.md)].  
...
1.  Open [!INCLUDE[vsprvslong](../../../reference/admin/includes/vsprvslong-md.md)].  
...
1.  Create the module-definition file to export the [RegisterModule](../../../web-dev-reference/native-code-api-ref/pfn-registermodule-function.md) function:  
    ...
    6.  Add a line with `EXPORTS` and `RegisterModule`. Your file should look like the code below:  
        ...
        > [!NOTE]
        >  Instead of creating a module-definition file, you can export the [RegisterModule](../../../web-dev-reference/native-code-api-ref/pfn-registermodule-function.md) function by using the **/EXPORT:RegisterModule** switch.  
...
-   Ensure that IIS has loaded HelloWorld.dll:  
    ...
    1.  In [!INCLUDE[iismgr](../../../reference/admin/includes/iismgr-md.md)], click **Default Web Site** in the **Connections** pane.  
