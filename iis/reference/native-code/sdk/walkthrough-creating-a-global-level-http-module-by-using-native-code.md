...
2.  You can optionally export the [RegisterModule](../../../web-dev-reference/native-code-api-ref/pfn-registermodule-function.md) function by using the **/EXPORT:RegisterModule** switch:  
