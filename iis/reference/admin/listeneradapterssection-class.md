...
|Name|Description|  
|----------|-----------------|  
|`ListenerAdapters`|An array of [ListenerAdapterElement](../../reference/admin/listeneradapterelement-class.md) values.|  
...
## See Also  
 ...
 [ListenerAdapterElement Class](../../reference/admin/listeneradapterelement-class.md)