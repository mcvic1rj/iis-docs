...
|`UrlMappings`|An array of read/write [UrlMapping](../../reference/admin/urlmapping-class.md) values, each of which contains an inbound display URL and the Web application URL to which the inbound display URL is mapped.|  
...
## See Also  
 ...
 [UrlMapping Class](../../reference/admin/urlmapping-class.md)