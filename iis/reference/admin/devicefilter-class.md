...
## Remarks  
 Instances of this class are contained in the `DeviceFilters` property of the [DeviceFiltersSection](../../reference/admin/devicefilterssection-class.md) class.  
 ...
 The following `DeviceFilters` element is not explicitly configured in the machine configuration file or in the root Web.config file, but it is the default configuration returned in the [!INCLUDE[dnprdnlong](../../reference/admin/includes/dnprdnlong-md.md)].  
...
## See Also  
 ...
 [DeviceFiltersSection Class](../../reference/admin/devicefilterssection-class.md)   
