...
## Remarks  
 Instances of this class are contained in the `ListenerAdapters` property of the [ListenerAdaptersSection](../../reference/admin/listeneradapterssection-class.md) class.  
...
## See Also  
 ...
 [ListenerAdaptersSection Class](../../reference/admin/listeneradapterssection-class.md)