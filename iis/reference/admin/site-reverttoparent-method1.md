...
|Name|Description|  
|----------|-----------------|  
|`PropertyName`|An optional `string` value that contains the name of the Web site property that is to be reverted to the default specified by [SiteElementDefaults](../../reference/admin/siteelementdefaults-class1.md). The property can be nested (for example, "LogFile.Directory").|  
...
> [!NOTE]
>  The `LogFile` property of the [Site](../../reference/admin/site-class1.md) class contains an instance of the [SiteLogFile](../../reference/admin/sitelogfile-class1.md) class. The `SiteLogFile` instance has a `Directory` property. You specify this nested property by using `oSite.RevertToParent("LogFile.Directory")`.  
