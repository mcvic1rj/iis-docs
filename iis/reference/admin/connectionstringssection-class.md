...
Specifies a collection of database connection strings for [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] applications.  
  
## Syntax  
  
```vbs  
class ConnectionStringsSection : ConfigurationSectionWithCollection  
```  
...
|Name|Description|  
|----------|-----------------|  
|`ConnectionStrings`|An array of [ConnectionStringSettings](../../reference/admin/connectionstringsettings-class.md) values that contain database connection strings for [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] applications and features.|  
...
## See Also  
 ...
 [ConnectionStringSettings Class](../../reference/admin/connectionstringsettings-class.md)