...
|Name|Description|  
|----------|-----------------|  
|`ServiceDescriptionFormatExtensionTypes`|An array of [TypeElement](../../reference/admin/typeelement-class.md) values that specify the service description format extensions to run in the scope of the configuration file.|  
  
## Subclasses  
 This class contains no subclasses.  
  
## Remarks  
 Instances of this class are contained in the `ServiceDescriptionFormatExtensionTypes` array property of the [WebServicesSection](../../reference/admin/webservicessection-class.md) class.  
