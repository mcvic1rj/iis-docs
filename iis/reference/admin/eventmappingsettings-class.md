...
|Name|Description|  
|----------|-----------------|  
|`EventMappings`|An array of [EventMappingElement](../../reference/admin/eventmappingelement-class.md) objects that map friendly event names to related event types.|  
  
## Subclasses  
 This class contains no subclasses.  
  
## Remarks  
 Instances of this class are contained in the `EventMappings` array property of the [HealthMonitoringSection](../../reference/admin/healthmonitoringsection-class.md) class.  
...
## See Also  
 ...
 [EventMappingElement Class](../../reference/admin/eventmappingelement-class.md)   
