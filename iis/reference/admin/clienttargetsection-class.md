...
|Name|Description|  
|----------|-----------------|  
|`ClientTarget`|An array of [ClientTarget](../../reference/admin/clienttarget-class.md) values that map aliases to specific user agents.|  
...
## See Also  
 ...
 [ClientTarget Class](../../reference/admin/clienttarget-class.md)   
