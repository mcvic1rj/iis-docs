...
Specifies whether an [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] application should run as the application pool identity (the default), the IIS-authenticated user identity, or a custom configured identity.  
