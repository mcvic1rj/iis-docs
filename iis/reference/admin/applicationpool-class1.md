---
title: "ApplicationPool Class1 | Microsoft Docs"
ms.custom: ""
ms.date: "10/07/2016"
ms.reviewer: ""
ms.suite: ""
...
|Name|Description|  
|----------|-----------------|  
|[Create](../../reference/admin/applicationpool-create-method2.md)|Creates an application pool.|  
|[GetState](../../reference/admin/applicationpool-getstate-method2.md)|Returns the run-time state of an application pool.|  
|[Recycle](../../reference/admin/applicationpool-recycle-method2.md)|Recycles an application pool.|  
|[RevertToParent](../../reference/admin/applicationpool-reverttoparent-method1.md)|Reverts an application pool's configuration value or values to those of its parent application pool.|  
|[Start](../../reference/admin/applicationpool-start-method1.md)|Starts an application pool.|  
|[Stop](../../reference/admin/applicationpool-stop-method1.md)|Stops an application pool.|  
...
|`Failure`|An [ApplicationPoolFailureSettings](../../reference/admin/applicationpoolfailuresettings-class1.md) object that defines the properties that determine the actions to be taken when an application pool or worker process fails.|  
...
## Remarks  
 ...
 If a managed application runs in an application pool with Integrated mode, the server will use the integrated request-processing pipelines of IIS and [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] to process the request. However, if a managed application runs in an application pool with ISAPI mode, the server will continue to route requests for managed code through Aspnet_isapi.dll and process requests as if they were running in IIS 6.0.  
