...
Specifies a transmission protocol that [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] can use to decrypt data sent in the HTTP request from a client browser.  
...
|`Name`|A unique nonempty read-only `string` value that specifies the name of a transmission protocol that [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] can use to decrypt data sent in the HTTP request from a client browser. The key property.|  
...
## Remarks  
 Instances of this class are contained in the `Protocols` property of the [ProtocolsSection](../../reference/admin/protocolssection-class.md) class.  
...
## See Also  
 ...
 [ProtocolsSection Class](../../reference/admin/protocolssection-class.md)   
