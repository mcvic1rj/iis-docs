...
Contains a collection of extensions that map XML Schema (XSD) types to [!INCLUDE[dnprdnshort](../../reference/admin/includes/dnprdnshort-md.md)] types.  
...
|`SchemaImporterExtensions`|An array of [NameTypeElement](../../reference/admin/nametypeelement-class.md) values that specify the names and types of [!INCLUDE[dnprdnshort](../../reference/admin/includes/dnprdnshort-md.md)] extensions that map XSD types to [!INCLUDE[dnprdnshort](../../reference/admin/includes/dnprdnshort-md.md)] types.|  
