...
|`ManyToOneMappings`|A [ManyToOneSettings](../../reference/admin/manytoonesettings-class.md) value that specifies many-to-one client certificate mappings.|  
...
|`OneToOneMappings`|A [OneToOneSettings](../../reference/admin/onetoonesettings-class.md) value that specifies one-to-one client certificate mappings.|  
