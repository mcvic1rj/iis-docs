...
## Remarks  
 Instances of this class are contained in the `SectionInformation` property of the [ConfigurationSection](../../reference/admin/configurationsection-class1.md) class. All configuration section classes inherit the `SectionInformation` class as one of their properties.  
