...
|Name|Description|  
|----------|-----------------|  
|`DenyUrlSequences`|An array of [UrlSequence](../../reference/admin/urlsequence-class.md) values that specify URL sequences that request filtering will deny.|  
  
## Subclasses  
 This class contains no subclasses.  
  
## Remarks  
 Instances of this class are contained in the `DenyUrlSequences` array property of the [RequestFilteringSection](../../reference/admin/requestfilteringsection-class.md) class.  
