...
Configures the [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] event-buffering settings for event providers.  
...
## Remarks  
 Instances of this class are contained in the `BufferModes` array property of the [BufferModeSettings](../../reference/admin/buffermodesettings-class.md) class.  
