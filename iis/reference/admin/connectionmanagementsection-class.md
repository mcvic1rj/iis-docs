...
|Name|Description|  
|----------|-----------------|  
|`ConnectionManagement`|An array of [ConnectionManagementElement](../../reference/admin/connectionmanagementelement-class.md) values that define the maximum number of connections to a server or group of servers.|  
...
## See Also  
 ...
 [ConnectionManagementElement Class](../../reference/admin/connectionmanagementelement-class.md)