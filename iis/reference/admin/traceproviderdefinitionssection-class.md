...
|`TraceProviderDefinitions`|A read/write array of [TraceProviderDefinition](../../reference/admin/traceproviderdefinition-class.md) elements that specify trace providers.|  
