...
|Name|Description|  
|----------|-----------------|  
|[Create](../../reference/admin/application-create-method1.md)|Creates a Web application.|  
...
|[RevertToParent](../../reference/admin/application-reverttoparent-method1.md)|Reverts an application's configuration value or values to the default.|  
...
|`VirtualDirectoryDefaults`|A [VirtualDirectoryElementDefaults](../../reference/admin/virtualdirectoryelementdefaults-class1.md) object whose read/write properties specify default values for virtual directories under the application.|  
...
>  The name of the application pool is case-sensitive.  
 ...
 To set the default application pool for all the applications in a Web site, use the `ApplicationDefaults` property of the [Site](../../reference/admin/site-class1.md) class.  
