...
|`AppSettings`|An array of [KeyValueElement](../../reference/admin/keyvalueelement-class.md) values that contain key/value pairs that specify application setting names and corresponding values.|  
...
## See Also  
 ...
 [KeyValueElement Class](../../reference/admin/keyvalueelement-class.md)   
