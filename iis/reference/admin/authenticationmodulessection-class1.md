...
```vbs  
class AuthenticationModulesSection : ConfigurationSectionWithCollection  
```  
...
|Name|Description|  
|----------|-----------------|  
|`AuthenticationModules`|An array of [AuthenticationModuleElement](../../reference/admin/authenticationmoduleelement-class.md) values that specify types for authentication modules.|  
...
## See Also  
 ...
 [AuthenticationModuleElement Class](../../reference/admin/authenticationmoduleelement-class.md)