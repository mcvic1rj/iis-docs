...
Specifies the output-cache profile settings that can be applied to pages in an [!INCLUDE[vstecasp](../../reference/includes/vstecasp-md.md)] application.  
...
|`OutputCacheProfiles`|An [OutputCacheProfileSettings](../../reference/admin/outputcacheprofilesettings-class.md) value that contains cache settings that can be applied to pages to specify the [OutputCache](../../reference/admin/outputcachesection-class.md) directive.|  
...
## See Also  
 ...
 [OutputCacheProfileSettings Class](../../reference/admin/outputcacheprofilesettings-class.md)