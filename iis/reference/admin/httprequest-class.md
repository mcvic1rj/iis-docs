...
|`PipelineState`|A read-only `uint32` value that contains the pipeline module state that the request is in. The possible values are listed in [Request-Processing Constants](../../web-dev-reference/native-code-api-ref/request-processing-constants.md).|  
...
## See Also  
 [Request-Processing Constants](../../web-dev-reference/native-code-api-ref/request-processing-constants.md)   
