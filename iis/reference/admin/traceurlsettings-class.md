...
|Name|Description|  
|----------|-----------------|  
|`TraceUrls`|An array of [StringElement](../../reference/admin/stringelement-class.md) values that specify URLs to trace.|  
  
## Subclasses  
 This class contains no subclasses.  
  
## Remarks  
 Instances of this class are contained in the `HttpTracing` array property of the [HttpTracingSection](../../reference/admin/httptracingsection-class.md) class.  
